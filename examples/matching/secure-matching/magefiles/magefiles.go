...
func build(buildCfg string) error {
	...
	switch runtime.GOOS {
	case "linux":
		diarkisCli = "../../../src/diarkis-cli/os/linux/bin/diarkis-cli"
	case "darwin":
		diarkisCli = "../../../src/diarkis-cli/os/mac/bin/diarkis-cli"
	case "windows":
		diarkisCli = "../../../src/diarkis-cli/os/windows/bin/diarkis-cli.exe"
	}

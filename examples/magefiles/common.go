...
// rootDir is defined in each sample.
// const rootDir = "../.."
...
func Server(target string) error {
	...
	// do not allow servers to use all the cpu by default.
	_, err := sh.Exec(map[string]string{"GOMAXPROCS": "1"}, os.Stdout, os.Stderr, exe, args...)
	return err
}
